...
function BeamConnector({ delay = 0, path }: { delay?: number; path: string }) {
  return (
    ...
    >
      ...
      <path
        className="motion-safe-animation"
        d={path}
        stroke="#5AAEAE"
        strokeWidth="2"
        style={{
    ...
    <div className="relative isolate overflow-hidden rounded-3xl bg-teal-400 px-6 pt-12 pb-8 shadow-xl sm:px-12 sm:pt-16 lg:flex lg:items-start lg:gap-x-16 lg:px-16 lg:pt-0 lg:pb-0">
      ...
      <div className="mx-auto my-auto max-w-md py-8 text-left sm:text-center lg:mx-0 lg:flex-auto lg:py-16 lg:text-left">
        ...
        <div className="mt-8">
          <a
            href="/research"
            className="group inline-flex items-center gap-x-2 rounded-lg bg-teal-50 px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors duration-150 hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-700 focus-visible:ring-offset-2"
          >
            Learn more
            <svg
